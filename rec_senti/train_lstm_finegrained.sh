...
CUDA_VISIBLE_DEVICES=0 python train_lstm.py --fig_path='log/lstm_finegrained/fig/' --bestmodel_dir='model/lstm_finegrained/' --logdir='log/lstm_finegrained/' --train_record='_data/finegrained_train.record' --valid_record='_data/finegrained_valid.record' --train_freq=10 --valid_freq=200 --valid_size=500 --lr=0.001 --patience=20 --summary_dir='log/summary/lstm_finegrained/' --max_step=1000000 --L2_lambda=0.0001 --class_size=5 #--load_model=True
