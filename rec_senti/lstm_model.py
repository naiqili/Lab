...
class LSTMModel():
    ...
    def build_cost(self, fw_hs, label_ts):
        ...
        all_weights = [self._W_i_mid, self._W_i_left, self._W_i_right, self._W_f_mid, self._W_f_left_left, self._W_f_left_right, self._W_f_right_left, self._W_f_right_right, self._W_o_mid, self._W_o_left, self._W_o_right, self._W_u_mid, self._W_u_left, self._W_u_right, self._proj_W]
