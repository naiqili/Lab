...
from bi_basic_model2 import BiBasicModel
...
flags.DEFINE_integer("test_size", 1000, "Size of test data")
...
flags.DEFINE_string("train_record", 'tmp/train.record', "training record file")
flags.DEFINE_string("valid_record", 'tmp/valid.record', "valid record file")
flags.DEFINE_string("test_record", 'tmp/test.record', "test record file")
...
def test():
    ...
    test_md = BiBasicModel(config_dict)
