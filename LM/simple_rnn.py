...
class SimpleRNN(Model):
    ...
    def init_params(self):
        ...
        self.W = add_to_params(self.params, theano.shared(value=NormalInit(self.rng, self.embdim + self.hdim, self.hdim), name='W'+self.name))
        self.b = add_to_params(self.params, theano.shared(value=np.zeros((self.hdim,), dtype='float32'), name='b'+self.name))
    ...
    def simplernn_step(self, x_t, m_t, h_tm1):
        if m_t.ndim >= 1:
