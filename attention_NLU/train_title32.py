...
def main(args):     
    ...
    while (step < state['loop_iters'] and
        ...
        X = batch['X']
        Xmask = batch['Xmask']
        title_in = batch['title_in']
        title_out = batch['title_out']
        titlemask = batch['titlemask']
...
if __name__ == "__main__":
    ...
    args.resume = 'model/title_emb256_h256_f32_tok10'
    main(args)
